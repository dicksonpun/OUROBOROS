    ...
    public class LicenseLogViewModel : ViewModel
    {
        ...
        public LicenseLogViewModel() : base()
        {
            m_items = new List<LicenseLogItem>()
            {
                ...
                new LicenseLogItem() { PackageName = "Application Icon",         Description = "Panda Icon",                                              License = "Free",    Version = "Low-Resolution",  ReferenceURL = "https://www.freelogodesign.org/"                                     },
                ...
                new LicenseLogItem() { PackageName = "MaterialDesignExtensions", Description = ".NET library for additional Material Design controls",    License = "MIT",     Version = "2.5.0.1 ",        ReferenceURL = "https://github.com/spiegelp/MaterialDesignExtensions"                },
